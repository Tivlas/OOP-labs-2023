namespace Lab2.Const
{
    public static class Constants
    {
        public static readonly string HelpInfo =
            ...
            $"Enter {4,3} to add card\r\n" +
            $"Enter {44,3}to remove card\r\n" +
            $"Enter {444,3} to print ur cards\r\n" +
            $"Enter {5,3} to add transaction category\r\n" +
            $"Enter {55,3} to remove category\r\n" +
            ...
            $"Enter {7,3} to add transfer\r\n" +
            $"Enter {77,3} to remove transfer\r\n" +
            $"Enter {777,3} to print ur transfers";
